...
class Location extends AbstractBotCommands {
    ...
    function commandLocationMessages() {
        if (property_exists($this->request->message, 'location')) {
            ...
            return [
                'text' => "Кажется, у вас установлена немного устаревшая версия Telegram. Пожалуйста, обновите программу на самую последнюю версию, чтобы получить возможность передать боту свои координаты.",
                'buttons' => [[[
                    'text' => 'Указать своё местоположение',
                    'request_location' => true
                ]]],
